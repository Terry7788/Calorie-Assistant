/**
 * logger.js — Safe logging with automatic redaction of sensitive values.
 *
 * Redacts:
...
/**
 * Drop-in replacements for console.log / console.error / console.warn.
 * Usage: logger.log('[DEBUG] body:', req.body)
 *        logger.error('[ERROR] something failed', err)
 */
const logger = {
  log(...args) {
  ...
  /** Convenience: log a labelled object safely */
  debug(label, value) {
